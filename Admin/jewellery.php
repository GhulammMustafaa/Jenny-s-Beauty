        ...
        <div class="col-10">
            <div class="card card-default">
                <div class="card-header card-header-border-bottom d-flex justify-content-between">
                    <a href="add_jewellery.php" class="btn btn-primary"><b>+</b> Add Jewellery</a>
                </div>
                <div class="card-body">
                    <div class="basic-data-table">
                        <table id="basic-data-table" class="table nowrap text-center" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM jewellery ORDER BY id DESC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="updateJewellery.php?id=<?php echo $row[0]; ?>"><i class="fa-solid fa-pen-to-square text-info"></i></a> |
                                            <a href="delete_jewellery.php?id=<?php echo $row[0]; ?>"><i class="fa-solid fa-trash text-danger"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
